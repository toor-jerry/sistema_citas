...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
            ...
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    if ("number" === typeof q[f] && 0 <= q[f]) { for (; l.length <= q[f];) Ga(a);
                        d(q[f], m) } else if ("number" === typeof q[f] && 0 > q[f]) d(l.length +
                    q[f], m);
            ...
            for (e = g.length; d < e; d++) {
                ...
                for (b = g[d].length; f < b; f++)
                    if (m = i = 1, j[d][f] === k) {
                        ...
                        for (; g[d][f + m] !== k && g[d][f].cell == g[d][f + m].cell;) { for (c = 0; c < i; c++) j[d + c][f + m] = 1;
                            m++ }
    ...
    function P(a) {
        ...
        if (-1 !== h.inArray(!1, b)) D(a, !1);
            ...
            if (0 !== i.length) {
                f =
                    j ? a.aoData.length : m;
                for (j = j ? 0 : g; j < f; j++) { var l = i[j],
                        q = a.aoData[l];
                    null === q.nTr && Ja(a, l); var u = q.nTr; if (0 !== e) { var G = d[c % e];
    ...
    function Ab(a) {
        for (var b = n.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f <
            g; f++) { for (var j = [], i = 0, m = c.length; i < m; i++) e = c[i], d = a.aoData[e], b[f](a, d._aFilterData, e, d._aData, i) && j.push(e);
            c.length = 0;
            h.merge(c, j) }
    }
    ...
    function Bb(a) {
        ...
        for (f = a.aoData.length; d < f; d++)
            if (h =
                ...
                e = 0; for (g = b.length; e < g; e++) c = b[e], c.bSearchable ? (i = B(a, d, e, "filter"), l[c.sType] && (i = l[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (wa.innerHTML = i, i = Zb ? wa.textContent : wa.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), j.push(i);
                h._aFilterData = j;
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            s && I(function(a, b) { a.innerHTML = '<div class="dataTables_sizing">' + z[b] + "</div>";
                ...
                a.childNodes[0].style.overflow = "hidden";
                a.style.width = x[b] }, R);
            if (p.outerWidth() < f) { Q = j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y") ? f + b : f; if (V && (j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y"))) t.width = w(Q - b);
    ...
    var n = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (v.length) { var U = function(a, b) { return a.getAttribute("data-" + b) !== null ? b : null };
                        h(v[0]).children("th, td").each(function(a, b) { var c = p.aoColumns[a]; if (c.mData === a) { var d = U(b, "sort") || U(b, "order"),
    ...
    h.extend(r.prototype, {
        ...
        iterator: function(a, b, c, d) {
            ...
            for (j = l.length; g < j; g++) {
                var t = new r(l[g]);
                if (b === "table") { f = c.call(t, l[g], g);
                    f !== k && e.push(f) } else if (b === "columns" || b === "rows") {
                    f = c.call(t,
                        l[g], this[g], g);
                    f !== k && e.push(f)
                } else if (b === "column" || b === "column-rows" || b === "row" || b === "cell") { o = this[g];
                    b === "column-rows" && (n = Da(l[g], s.opts));
                    i = 0; for (h = o.length; i < h; i++) { f = o[i];
                        f = b === "cell" ? c.call(t, l[g], f.row, f.column, g, i) : c.call(t, l[g], f, g, i, n);
                        f !== k && e.push(f) } }
            }
            if (e.length || d) { a = new r(l, a ? e.concat.apply([], e) : e);
                b = a.selector;
                b.rows = s.rows;
                b.cols = s.cols;
                b.opts = s.opts; return a }
            return this
        },
        ...
        if (Array.isArray(a))
            ...
            for (var e = a.split("."), f = Ub, g, j, c = 0, d = e.length; c < d; c++) {
                ...
                if (!i) { i = { name: g, val: {}, methodExt: [], propExt: [], type: "object" };
                    f.push(i) }
                if (c === d - 1) { i.val = b;
                    i.type = typeof b === "function" ? "function" : h.isPlainObject(b) ? "object" : "other" } else f =
    ...
    var bb = function(a, b, c, d, e) {
        ...
        db = function(a) { for (var b = 0, c = a.length; b < c; b++)
                if (a[b].length > 0) { a[0] = a[b];
                    a[0].length = 1;
                    a.length = 1;
                    a.context = [a.context[b]]; return a }
            a.length = 0; return a },
        Da = function(a,
            b) {
            var c, d, e, f = [],
            ...
            else { if (j == "removed") { var i = {};
                    c = 0; for (d = g.length; c < d; c++) i[g[c]] = null;
                    f = h.map(e, function(a) { return !i.hasOwnProperty(a) ? a : null }) } } else if (c == "index" || c == "original") {
                c = 0;
            ...
            c = this.iterator("table", function(c) {
                ...
                return bb("row", a, function(a) {
                    ...
                    if (a.nodeName) { var b = a._DT_RowIndex,
                            m = a._DT_CellIndex; if (b !== k) return i[b] && i[b].nTr === a ? [b] : []; if (m) return i[m.row] && i[m.row].nTr === a.parentNode ? [m.row] : [];
                ...
                if (d._details) {
                    ...
                    if (C(g, "_details").length > 0) {
                        ...
                        f.on("column-visibility.dt.DT_details", function(a, b) { if (e === b)
                                for (var c, d = W(b), f = 0, h = g.length; f < h; f++) { c = g[f];
        ...
        function(a, b) {
            var c = this,
                d = this.iterator("column", function(b, c) { if (a === k) return b.aoColumns[c].bVisible; var d = b.aoColumns,
                        j = d[c],
                        i = b.aoData,
                        m, l, n; if (a !== k && j.bVisible !== a) { if (a) { var o = h.inArray(true, C(d, "bVisible"), c + 1);
                            m = 0; for (l = i.length; m < l; m++) { n = i[m].nTr;
                                d = i[m].anCells;
                                n && n.insertBefore(d[c], d[o] || null) } } else h(C(b.aoData, "anCells", c)).detach();
                        j.bVisible = a } });
    ...
    o("cells()", function(a, b, c) {
            ...
            return bb("cell", d, function(a) {
                ...
                if (a === null || a === k || c) {
                    ...
                    for (r = g.length; s < r; s++) {
                        m =
                            g[s];
                        for (t = 0; t < n; t++) { w = { row: m, column: t }; if (c) { v = f[m];
                                a(w, B(b, m, t), v.anCells ? v.anCells[t] : null) && o.push(w) } else o.push(w) }
                    }
                    return o
                }
        ...
        var d = c ? {
            ...
            e = this.columns(b, d),
            f = this.rows(a, d),
            g, j, i, m, d = this.iterator("table", function(a, b) { var c = [];
                g = 0; for (j = f[b].length; g < j; g++) { i = 0; for (m = e[b].length; i < m; i++) c.push({ row: f[b][g], column: e[b][i] }) } return c }, 1),
    ...
    n.versionCheck = n.fnVersionCheck = function(a) { for (var b = n.version.split("."), a = a.split("."), c, d, e = 0, f = a.length; e < f; e++) { c = parseInt(b[e], 10) || 0;
            d = parseInt(a[e], 10) || 0; if (c !== d) return c > d } return true };
    n.isDataTable = n.fnIsDataTable = function(a) { var b = h(a).get(0),
            c = false; if (a instanceof n.Api) return true;
        h.each(n.settings, function(a, e) { var f = e.nScrollHead ? h("table", e.nScrollHead)[0] : null,
                g = e.nScrollFoot ? h("table", e.nScrollFoot)[0] : null; if (e.nTable === b || f === b || g === b) c = true }); return c };
    n.tables = n.fnTables =
        function(a) { var b = false; if (h.isPlainObject(a)) { b = a.api;
                a = a.visible } var c = h.map(n.settings, function(b) { if (!a || a && h(b.nTable).is(":visible")) return b.nTable }); return b ? new r(c) : c };
    ...
    h.each(["column", "row", "cell"], function(a, b) {
        o(b + "s().every()",
            function(a) { var d = this.selector.opts,
                    e = this; return this.iterator(b, function(f, g, h, i, m) { a.call(e[b](g, b === "cell" ? h : d, b === "cell" ? d : k), g, h, i, m) }) })
    });
    ...
    n.defaults = {
        ...
        fnStateSaveCallback: function(a, b) { try {
                (a.iStateDuration === -1 ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) {} },
                ...
                var g = a.oClasses,
                    ...
                    o = function(b, d) {
                        ...
                        for (s = d.length; k < s; k++) {
                            t = d[k];
                            if (Array.isArray(t)) { r = h("<" + (t.DT_el || "div") + "/>").appendTo(b);
                                o(r, t) } else {
                                m = null;
                                l = t;
                                r = a.iTabIndex;
                                switch (t) {
                                    ...
                                    case "first":
                                        m = j.sFirst; if (e === 0) { r = -1;
                                            l = l + (" " + v) } break;
                                    case "previous":
                                        m = j.sPrevious; if (e === 0) { r = -1;
                                            l = l + (" " + v) } break;
                                    case "next":
                                        m = j.sNext; if (f === 0 || e === f - 1) { r = -1;
                                            l = l + (" " + v) } break;
                                    case "last":
                                        m = j.sLast; if (f === 0 || e === f - 1) { r = -1;
                                            l = l + (" " + v) } break;
                                    default:
    ...
    var Ba =
        function(a, b, c, d) { if (a !== 0 && (!a || a === "-")) return -Infinity;
    ...
    n.render = { number: function(a, b, c, d, e) { return { display: function(f) { if (typeof f !== "number" && typeof f !== "string") return f; var g = f < 0 ? "-" : "",
